...
export const chainConfig: Configs = {
	...
	'100': {
		...
		contracts: {
			...
			bzzToken: '0xdBF3Ea6F5beE45c02255B2c26a16F300502F68da'.toLowerCase(), // correct
			postageStamp: '0x6a1A21ECA3aB28BE85C7Ba22b2d6eAE5907c900E'.toLowerCase(), // correct
			priceOracle: '0x0FDc5429C50e2a39066D8A94F3e2D2476fcc3b85'.toLowerCase(), // correct, "xdaiContractAddress" in pkg/config/chain.go
		},
	},
}
