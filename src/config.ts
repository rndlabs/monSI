	...
	'5': {
		...
		contracts: {
			...
			redistribution: utils.getAddress(
				'0x3174ed554247b3457922aecfcbdb17db123e519c'
			), // correct 2022/11/14 from pkg/config/chain.go
			stakeRegistry: utils.getAddress(
				'0x39fc8db5d43c68379155b41451aa38190faa3498'
			), // correct 2022/11/14 from pkg/config/chain.go
			...
			postageStamp: utils.getAddress(
				'0xf0a7e63f72a73bd339a7ee814aefa80995e532a0'
			), // correct 2022/11/14 from pkg/config/chain.go
			priceOracle: utils.getAddress(
				'0x2b308ceb1ff7398e93b008c9a9ea82ffcf6a7a24'
			), // correct 2022/11/14 from Redistribution constructor
		},
	},
	'100': {
		...
		contracts: {
			redistribution: utils.getAddress(
				'0xF4963031E8b9f9659CB6ed35E53c031D76480EAD'
			), // wrong
			stakeRegistry: utils.getAddress(
				'0x18391158435582D5bE5ac1640ab5E2825F68d3a4'
			), // wrong
			stakeDeployBlock: 7951984,
			bzzToken: utils.getAddress('0xdBF3Ea6F5beE45c02255B2c26a16F300502F68da'), // correct
			postageStamp: utils.getAddress(
				'0x6a1A21ECA3aB28BE85C7Ba22b2d6eAE5907c900E'
			), // correct
			priceOracle: utils.getAddress(
				'0x0FDc5429C50e2a39066D8A94F3e2D2476fcc3b85'
			), // correct, "xdaiContractAddress" in pkg/config/chain.go
		},
	},
}
